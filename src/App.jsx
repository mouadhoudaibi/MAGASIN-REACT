...
function App() {
  ...
  return (
    <div className="container">
      ...
      <div className="search-bar">
          ...
          />
          {searchTerm && (
              <button style={{color: 'red'}} onClick={clearSearch} className="clear-button"><MdCancel size={20} />n</button>
            )}
        </div>
        {/* <p>{searchTerm}</p> */}
  ...
  {displayedProducts.length > 0 ? (
    ...
    // <p className="no-results">Aucun produit ne correspond à votre recherche {searchTerm}.</p>
    // <p className="no-results">Aucun produit trouvé sur {searchTerm}.</p>
    <p className="no-results"> Déçu(e) que le produit {searchTerm} ne soit pas disponible en magasin, j'espère qu'il sera réapprovisionné bientôt</p>
